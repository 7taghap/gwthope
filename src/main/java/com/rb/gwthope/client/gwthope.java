...
import com.rb.gwthope.client.gin.Injector;
...
//  private final UserServiceAsync userService = GWT.create(UserService.class);
  ...
  public void onModuleLoad() {
	 ...
	 QuickStartGinApp ginApp = ginjector.getQuickStartGinApp();
	 ginApp.run();
  ...
  private void logEvent(EventBus eventBus) {
	  eventBus.addHandler(GetNameEvent.getType(), new GetNameHandler() {
